...
Feel free to submit issues and enhancement requests [here](https:// github.com/Daironode/aingle/issues/new). Please consider [how to ask a good question](https://stackoverflow.com/help/how-to-ask) and take the time to research your issue before asking for help.

Duplicate questions will be closed.

Any unrelated comments or questions can be asked in the [AIngle Discord](https://discordapp.com/invite/4TQujHj).
