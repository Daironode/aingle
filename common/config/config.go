...
func NewAIngleConfig() *AIngleConfig {
	return &AIngleConfig{
...
func (this *AIngleConfig) GetBookkeepers() ([]keypair.PublicKey, error) {
...
func (this *AIngleConfig) GetDefaultNetworkId() (uint32, error) {
...
func (this *AIngleConfig) getDefNetworkIDFromGenesisConfig(genCfg *GenesisConfig) (uint32, error) {
	var configData []byte
	var err error
	switch this.Genesis.ConsensusType {
	case CONSENSUS_TYPE_VBFT:
