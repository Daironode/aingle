...
import (
	...
	" github.com/Daironode/aingle/cmd/common"
	" github.com/Daironode/aingle/cmd/utils"
	" github.com/Daironode/aingle/common/password"
...
You can use ./AIngle account --help command to view help information of wallet management command.`,
   ...
   AIngle support three type of key: ecdsa, sm2 and ed25519, and support 224、256、384、521 bits length of key in ecdsa, but only support 256 bits length of key in sm2 and ed25519.
   AIngle support multiple signature scheme.
