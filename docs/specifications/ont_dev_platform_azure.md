...
* ./aingle account list -v (View your wallet address,for example:ATcB3KHaC28dGgVPwU3DYUuXf5iBo1TLug)
* ./aingle asset transfer --from 1 --to 1 --asset=ont --amount=10000(Transfer your account to yourself)
* ./aingle asset unboundong 1(View the number of ong that can be transferred )
* ./aingle asset withdrawong 1(extract ong )
* ./aingle asset balance 1(Check the ong in your wallet. succeed)
