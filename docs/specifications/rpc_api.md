...
The document description remote process call(RPC) specification in Onchain AIngle.
...
Hex: Serialized signed transactions constructed in the program into hexadecimal strings. Building the parameter,please refer to NewNativeInvokeTransaction in aingle-go-sdk/rpc.go
