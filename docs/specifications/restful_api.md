...
This document describes the restful api format for the http/https used in the Onchain AIngle.
...
| [get_version](#20-get_version) |  GET /api/v1/version | return the version of aingle |
| [post_raw_tx](#21-post_raw_tx) | post /api/v1/transaction?preExec=0 | send transaction to aingle network |
...
```
{
    ...
    "Result": {
        ...
        "Description": "AIngle Network ONT Token"
    }
}
```
...
```
You can use the aingle-go-sdk to generate hex code, reference to [example](rpc_api.md#8-sendrawtransaction)
