...
/// Depending on the type of the commit, validate all possible validations for the SGD Op that would be produced by it
...
/// Write the new Headers records on Source Chain, with sgd_transforms_completed=false.
...
/// Triggers:
///
/// Publish to SGD (Public Chain Entries, Headers)
