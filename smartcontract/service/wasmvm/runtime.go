...
import (
	...
	native2 " github.com/Daironode/aingle/smartcontract/service/native"
	" github.com/Daironode/aingle/smartcontract/service/native/utils"
	" github.com/Daironode/aingle/smartcontract/service/util"
	" github.com/Daironode/aingle/smartcontract/states"
	" github.com/Daironode/aingle/vm/crossvm_codec"
	neotypes " github.com/Daironode/aingle/vm/neovm/types"
...
func NewHostModule() *wasm.Module {
	...
	m.Export = &wasm.SectionExports{
		Entries: map[string]wasm.ExportEntry{
			"aingle_timestamp": {
				FieldStr: "aingle_timestamp",
				Kind:     wasm.ExternalFunction,
				Index:    0,
			},
			"aingle_block_height": {
				FieldStr: "aingle_block_height",
				Kind:     wasm.ExternalFunction,
				Index:    1,
			},
			"aingle_input_length": {
				FieldStr: "aingle_input_length",
				Kind:     wasm.ExternalFunction,
				Index:    2,
			},
			"aingle_call_output_length": {
				FieldStr: "aingle_call_output_length",
				Kind:     wasm.ExternalFunction,
				Index:    3,
			},
			"aingle_self_address": {
				FieldStr: "aingle_self_address",
				Kind:     wasm.ExternalFunction,
				Index:    4,
			},
			"aingle_caller_address": {
				FieldStr: "aingle_caller_address",
				Kind:     wasm.ExternalFunction,
				Index:    5,
			},
			"aingle_entry_address": {
				FieldStr: "aingle_entry_address",
				Kind:     wasm.ExternalFunction,
				Index:    6,
			},
			"aingle_get_input": {
				FieldStr: "aingle_get_input",
				Kind:     wasm.ExternalFunction,
				Index:    7,
			},
			"aingle_get_call_output": {
				FieldStr: "aingle_get_call_output",
				Kind:     wasm.ExternalFunction,
				Index:    8,
			},
			"aingle_check_witness": {
				FieldStr: "aingle_check_witness",
				Kind:     wasm.ExternalFunction,
				Index:    9,
			},
			"aingle_current_blockhash": {
				FieldStr: "aingle_current_blockhash",
				Kind:     wasm.ExternalFunction,
				Index:    10,
			},
			"aingle_current_txhash": {
				FieldStr: "aingle_current_txhash",
				Kind:     wasm.ExternalFunction,
				Index:    11,
			},
			"aingle_return": {
				FieldStr: "aingle_return",
				Kind:     wasm.ExternalFunction,
				Index:    12,
			},
			"aingle_notify": {
				FieldStr: "aingle_notify",
				Kind:     wasm.ExternalFunction,
				Index:    13,
			},
			"aingle_debug": {
				FieldStr: "aingle_debug",
				Kind:     wasm.ExternalFunction,
				Index:    14,
			},
			"aingle_call_contract": {
				FieldStr: "aingle_call_contract",
				Kind:     wasm.ExternalFunction,
				Index:    15,
			},
			"aingle_storage_read": {
				FieldStr: "aingle_storage_read",
				Kind:     wasm.ExternalFunction,
				Index:    16,
			},
			"aingle_storage_write": {
				FieldStr: "aingle_storage_write",
				Kind:     wasm.ExternalFunction,
				Index:    17,
			},
			"aingle_storage_delete": {
				FieldStr: "aingle_storage_delete",
				Kind:     wasm.ExternalFunction,
				Index:    18,
			},
			"aingle_contract_create": {
				FieldStr: "aingle_contract_create",
				Kind:     wasm.ExternalFunction,
				Index:    19,
			},
			"aingle_contract_migrate": {
				FieldStr: "aingle_contract_migrate",
				Kind:     wasm.ExternalFunction,
				Index:    20,
			},
			"aingle_contract_destroy": {
				FieldStr: "aingle_contract_destroy",
				Kind:     wasm.ExternalFunction,
				Index:    21,
			},
			"aingle_panic": {
				FieldStr: "aingle_panic",
				Kind:     wasm.ExternalFunction,
				Index:    22,
			},
			"aingle_sha256": {
				FieldStr: "aingle_sha256",
				Kind:     wasm.ExternalFunction,
				Index:    23,
			},
			"aingle_gas_info": {
				FieldStr: "aingle_gas_info",
				Kind:     wasm.ExternalFunction,
				Index:    24,
			},
		},
