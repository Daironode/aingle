module github.com/Daironode/aingle
...
require (
	...
	github.com/Daironode/aingle-crypto v0.0.1
	github.com/Daironode/aingle-event v0.0.1
	github.com/Daironode/aingle-wagon v0.0.1
