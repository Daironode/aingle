...
const AI_SERVICE_PROTOCOL: &str = "._udp";
...
/// Create a thread that will broadcast a aingle service over mdns
...
pub fn mdns_create_broadcast_thread(
    ...
    let svc_type = format!("_{}{}", service_type, AI_SERVICE_PROTOCOL);
...
/// Queries the network for the aingle service.
