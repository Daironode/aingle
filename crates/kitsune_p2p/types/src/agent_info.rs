...
pub mod agent_info_helper {
    ...
    pub struct AgentMetaInfoEncode {
        pub sgd_storage_arc_half_length: u32,
    }
...
impl<'de> serde::Deserialize<'de> for AgentInfoSigned {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        let storage_arc = SgdArc {
            center_loc,
            half_length: meta.sgd_storage_arc_half_length,
        };
...
impl AgentInfoSigned {
    ...
    pub async fn sign<'a, R, F>(
        ...
        sgd_storage_arc_half_length: u32,
        url_list: UrlList,
        signed_at_ms: u64,
        expires_at_ms: u64,
        f: F,
        ...
        F: FnOnce(&[u8]) -> R,
    {
        ...
        let inner = AgentInfoInner {
            ...
            storage_arc: SgdArc {
                center_loc,
                half_length: sgd_storage_arc_half_length,
            },
            url_list,
            signed_at_ms,
            expires_at_ms,
