...
pub enum DnaUtilError {
    ...
    /// DnaError
    #[error("DNA error: {0}")]
    DnaError(#[from] aingle_types::dna::DnaError),
...
/// See `aingle_types::dna::zome::Zome`.
...
mod tests {
    ...
    async fn test_extract_then_compile() {
        ...
        let dna_file = aingle_types::test_utils::fake_dna_zomes(
            "bla",
            vec![
