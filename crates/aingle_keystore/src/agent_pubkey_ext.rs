...
/// Extend ai_hash::AgentPubKey with additional signature functionality
/// from Keystore.
pub trait AgentPubKeyExt {
    ...
    ) -> KeystoreApiFuture<ai_hash::AgentPubKey>
    where
        Self: Sized;
...
impl AgentPubKeyExt for ai_hash::AgentPubKey {
    fn new_from_pure_entropy(keystore: &KeystoreSender) -> KeystoreApiFuture<ai_hash::AgentPubKey>
    where
        Self: Sized,
    {
