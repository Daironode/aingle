...
/// Extend aingle_hash::AgentPubKey with additional signature functionality
/// from Keystore.
pub trait AgentPubKeyExt {
    ...
    ) -> KeystoreApiFuture<aingle_hash::AgentPubKey>
    where
        Self: Sized;
...
impl AgentPubKeyExt for aingle_hash::AgentPubKey {
    fn new_from_pure_entropy(keystore: &KeystoreSender) -> KeystoreApiFuture<aingle_hash::AgentPubKey>
    where
        Self: Sized,
    {
