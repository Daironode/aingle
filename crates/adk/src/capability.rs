...
///
/// Wraps the [ `create` ] ADK function with system type parameters set.
...
///
/// Wraps the [ `delete` ] ADK function with system type parameters set.
...
///
/// Wraps the [ `random_bytes` ] ADK function with appropriate parameters set.
