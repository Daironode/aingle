...
pub use adk_derive::adk_entry;
pub use adk_derive::adk_extern;
pub use ai_hash;
pub use ai_hash::AgentPubKey;
pub use ai_hash::AnySgdHash;
pub use ai_hash::EntryHash;
pub use ai_hash::EntryHashes;
pub use ai_hash::HasHash;
pub use ai_hash::HeaderHash;
pub use ai_hash::AiHash;
pub use aingle_wasmer_guest::*;
pub use aingle_zome_types;
...
#[macro_export]
macro_rules! aingle_externs {
    () => {
        aingle_wasmer_guest::host_externs!(
            __trace,
            __hash_entry,
            __unreachable,
            __verify_signature,
