...
pub use aingle_zome_types::fixt::*;
...
fixturator!(
    CellId;
    constructor fn new(SafHash, AgentPubKey);
);
...
// NB: Element is defined in aingle_zome_types, but I don't know if it's possible to define
