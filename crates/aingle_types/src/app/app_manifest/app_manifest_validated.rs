...
//! are structured to ensure validity, and are used internally by AIngle.

use super::error::{AppManifestError, AppManifestResult};
use crate::app::app_manifest::current::{SafLocation, SafVersionSpec};
