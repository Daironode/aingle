...
use crate::sgd_op::error::SgdOpError;
use crate::sgd_op::error::SgdOpResult;
use crate::sgd_op::SgdOpType;
use crate::sgd_op::RenderedOp;
use crate::sgd_op::RenderedOps;
...
impl WireLinkOps {
    ...
    pub fn render(self, key: &WireLinkKey) -> SgdOpResult<RenderedOps> {
...
impl WireCreateLink {
    ...
    /// Render these ops to their full types.
    pub fn render(self, key: &WireLinkKey) -> SgdOpResult<RenderedOp> {
        let tag = self
            .tag
            .or_else(|| key.tag.clone())
            .ok_or(SgdOpError::LinkKeyTagMissing)?;
