...
impl ZomeDef {
    ...
    pub fn wasm_hash(&self, zome_name: &ZomeName) -> DnaResult<aingle_hash::WasmHash> {
        match self {
...
pub struct WasmZome {
    ...
    pub wasm_hash: aingle_hash::WasmHash,
}
...
impl ZomeDef {
    /// create a Zome from a aingle_hash WasmHash instead of a aingle_hash one
    pub fn from_hash(wasm_hash: aingle_hash::WasmHash) -> Self {
