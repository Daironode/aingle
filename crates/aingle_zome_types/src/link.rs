...
pub struct Link {
    ...
    pub target: aingle_hash::EntryHash,
...
pub struct CreateLinkInput {
    pub base_address: aingle_hash::EntryHash,
    pub target_address: aingle_hash::EntryHash,
    pub tag: LinkTag,
}

impl CreateLinkInput {
    pub fn new(
        base_address: aingle_hash::EntryHash,
        target_address: aingle_hash::EntryHash,
        tag: LinkTag,
    ) -> Self {
        Self {
            base_address,
