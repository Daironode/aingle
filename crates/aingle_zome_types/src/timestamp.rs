...
/// A UTC timestamp for use in AIngle's headers.  It is assumed to be untrustworthy: it may
...
/// -- it is not acceptable for our core AIngle algorithms to panic when accessing SGD Header
...
/// supported by WASM; however, aingle_types provides a timestamp::now() method.
///
