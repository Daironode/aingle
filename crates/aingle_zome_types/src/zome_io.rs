...
// Every externed function that the zome developer exposes to aingle returns `ExternIO`.
...
wasm_io_types! {
    ...
    fn create_link (zt::link::CreateLinkInput) -> aingle_hash::HeaderHash;

    fn create_x25519_keypair(()) -> zt::x_salsa20_poly1305::x25519::X25519PubKey;

    // Returns HeaderHash of the newly created element.
    fn create (zt::entry::EntryWithDefId) -> aingle_hash::HeaderHash;
    ...
    fn delete_link (aingle_hash::HeaderHash) -> aingle_hash::HeaderHash;

    // Delete an element.
    fn delete (aingle_hash::HeaderHash) -> aingle_hash::HeaderHash;
    ...
    fn hash_entry (zt::entry::Entry) -> aingle_hash::EntryHash;
    ...
    fn update (zt::entry::UpdateInput) -> aingle_hash::HeaderHash;
