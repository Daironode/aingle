...
//! ```fish
//! env RUST_LOG='[{}]=debug' AI_WASM_CACHE_PATH='/path/to/aingle/.wasm_cache' \
...
use aingle::conductor::api::AppRequest;
use aingle::conductor::api::AppResponse;
use aingle::conductor::api::RealAppInterfaceApi;
use aingle::conductor::api::ZomeCall;
use aingle::conductor::config::AdminInterfaceConfig;
use aingle::conductor::config::ConductorConfig;
use aingle::conductor::config::InterfaceDriver;
use aingle::conductor::ConductorBuilder;
use aingle::conductor::ConductorHandle;

use aingle_state::{prelude::test_environments, test_utils::TestEnvs};
use aingle_test_wasm_common::AnchorInput;
...
async fn speed_test_prep() {
    aingle::test_utils::warm_wasm_tests();
}
