...
pub fn x_salsa20_poly1305_encrypt(
    ...
    Ok(
        aingle_zome_types::x_salsa20_poly1305::encrypted_data::XSalsa20Poly1305EncryptedData::new(
...
pub mod wasm_test {
    ...
    async fn invoke_import_xsalsa20_poly1305_encrypt_test() {
        ...
        let key_ref = XSalsa20Poly1305KeyRef::from(
            [1; aingle_zome_types::x_salsa20_poly1305::key_ref::KEY_REF_BYTES],
        );
        let data = XSalsa20Poly1305Data::from(vec![1, 2, 3, 4]);
        let input = aingle_zome_types::x_salsa20_poly1305::XSalsa20Poly1305Encrypt::new(
            key_ref,
            data.clone(),
        );
