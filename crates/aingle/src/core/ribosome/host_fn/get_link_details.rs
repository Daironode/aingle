...
pub mod slow_tests {
    ...
    async fn ribosome_entry_hash_path_children_details() {
        ...
        let _foo_bar: aingle_hash::EntryHash = crate::call_test_ribosome!(
            host_access,
            TestWasm::HashPath,
            "hash",
            "foo.bar".to_string()
        ...
        let _foo_baz: aingle_hash::EntryHash = crate::call_test_ribosome!(
            host_access,
            TestWasm::HashPath,
            "hash",
            "foo.baz".to_string()
        ...
        let _remove_hash: aingle_hash::HeaderHash = crate::call_test_ribosome!(
            host_access,
            TestWasm::HashPath,
            "delete_link",
            to_remove_hash
