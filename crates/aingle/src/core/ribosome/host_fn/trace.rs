...
pub fn wasm_trace(input: TraceMsg) {
    match input.level {
        aingle_types::prelude::Level::TRACE => tracing::trace!("{}", input.msg),
        aingle_types::prelude::Level::DEBUG => tracing::debug!("{}", input.msg),
        aingle_types::prelude::Level::INFO => tracing::info!("{}", input.msg),
        aingle_types::prelude::Level::WARN => tracing::warn!("{}", input.msg),
        aingle_types::prelude::Level::ERROR => tracing::error!("{}", input.msg),
    }
}
