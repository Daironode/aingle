...
impl MigrateAgentInvocation {
    pub fn new(saf_def: SafDef, migrate_agent: MigrateAgent) -> Self {
        Self {
            saf_def,
            migrate_agent,
        }
...
impl From<&MigrateAgentHostAccess> for HostFnAccess {
    fn from(_: &MigrateAgentHostAccess) -> Self {
        ...
        access.saf_bindings = Permission::Allow;
        access
    }
}
...
/// the aggregate result of all zome callbacks for migrating an agent between safs
