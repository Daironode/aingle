...
impl RealRibosome {
    ...
    pub fn module(&self, zome_name: &ZomeName) -> RibosomeResult<Arc<Module>> {
        Ok(aingle_wasmer_host::module::MODULE_CACHE.write().get(
    ...
    fn imports(&self, call_context: CallContext, store: &Store) -> ImportObject {
        ...
        ns.insert(
            ...
            Function::new_native_with_env(
                store,
                env.clone(),
                aingle_wasmer_host::import::__import_data,
            ),
        );
        ...
        } = host_fn_access
        {
            host_fn_builder
                ...
                .with_host_function(&mut ns, "__saf_info", saf_info)
            ...
            host_fn_builder
                ...
                .with_host_function(&mut ns, "__saf_info", unreachable)
