...
use aingle_lmdb::db;
use aingle_lmdb::env::EnvironmentKind;
...
use aingle_state::source_chain::SourceChainBuf;
use aingle_state::wasm::WasmBuf;
    ...
    DS: DnaStore + 'static,
{
    ...
    pub(super) async fn load_wasms_into_dna_files(
        ...
        let wasm = environ.get_db(&*aingle_lmdb::db::WASM)?;
        let dna_def_db = environ.get_db(&*aingle_lmdb::db::DNA_DEF)?;
        let entry_def_db = environ.get_db(&*aingle_lmdb::db::ENTRY_DEF)?;
