...
use ::fixt::prelude::*;
pub use aingle_hash::fixt::*;
use aingle_hash::EntryHash;
use aingle_hash::HeaderHash;
use aingle_hash::WasmHash;
use aingle_keystore::keystore_actor::KeystoreSender;
use aingle_lmdb::test_utils::test_keystore;
use aingle_p2p::AIngleP2pCellFixturator;
use aingle_state::metadata::LinkMetaVal;
use aingle_types::fixt::TimestampFixturator;
...
fixturator!(
    ...
    curve Empty {
        ...
        let env = aingle_lmdb::test_utils::test_cell_env();
...
fixturator!(
    ZomeCallHostAccess;
    constructor fn new(CallZomeWorkspaceLock, KeystoreSender, AIngleP2pCell, SignalBroadcaster, CellConductorReadHandle, CellId);
);
...
fixturator!(
    InitHostAccess;
    constructor fn new(CallZomeWorkspaceLock, KeystoreSender, AIngleP2pCell);
);
...
fixturator!(
    ...
    constructor fn new(CallZomeWorkspaceLock, AIngleP2pCell);
);
