...
mod tests {
    ...
    use aingle_types::{env::EnvWrite, fixt::AppEntryTypeFixturator};
    use aingle_zome_types::header;
    use aingle_zome_types::header::builder;
    use aingle_zome_types::header::Delete;
    use aingle_zome_types::header::EntryType;
    use aingle_zome_types::header::HeaderBuilder;
    use aingle_zome_types::header::HeaderBuilderCommon;
    ...
    #[tokio::test(flavor = "multi_thread")]
    async fn test_entry_sgd_status() {
        // let test_env = test_cell_env();
        // let arc = test_env.env();
        // let mut fx = TestFixtures::new();
        // let entry_hash = fx.entry_hash();
        ...
        // fresh_reader_test!(arc, |mut reader| {
        //     let status = meta_buf()
        //         .get_sgd_status(&mut reader, &entry_hash.clone().into())
        //         .unwrap();
        //     assert_eq!(status, EntrySgdStatus::Live);
        // });
        // update_dbs(
        //     &entry_creates[..0],
        //     &entry_deletes[..],
        ...
        //         .get_sgd_status(&mut reader, &entry_hash.clone().into())
        //         .unwrap();
        //     assert_eq!(status, EntrySgdStatus::Dead);
        // });
    ...
    #[tokio::test(flavor = "multi_thread")]
    async fn test_entry_sgd_status_one_less() {
        // let test_env = test_cell_env();
        // let arc = test_env.env();
        // let mut fx = TestFixtures::new();
        // let entry_hash = fx.entry_hash();
