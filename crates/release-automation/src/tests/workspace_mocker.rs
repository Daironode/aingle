...
pub(crate) fn example_workspace_1<'a>() -> Fallible<WorkspaceMocker> {
    ...
    let members = vec![
        ...
        MockProject {
            ...
            changelog: Some(indoc::formatdoc!(
                ...
                [Unreleased]: https://github.com/AIngleLab/aingle/aingle_zome_types-v0.0.2-alpha.1...HEAD
                "#
            )),
        },
        MockProject {
    ...
    let workspace_mocker = WorkspaceMocker::try_new(
        ...
        # [20210304.120604]
        This will include the adk-0.0.100 release.

        ## [adk-0.0.100](crates/adk/CHANGELOG.md#0.0.100)
