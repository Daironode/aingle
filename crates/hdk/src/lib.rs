//! ## AIngle Development Kit 3.0 (HDK)
//!
//! This is the third major iteration of the AIngle Development Kit.
//!
//! The HDK exists to make working with WASM in aingle much easier.
//!
...
//!
//! The basic functionality of the HDK is to communicate with the aingle conductor using a specific typed interface.
//!
...
//!
//! HDK itself has a slower release cycle than the aingle conductor by design to make it easier to pin and track changes.
//!
...
//!
//! The HDK is used in all the wasms used to test aingle itself.
...
//!
//! At the time of writing there were about 40 example/test wasms that can be browsed [on github](https://github.com/Daironode/aingle/tree/develop/crates/test_utils/wasm/wasm_workspace).
//!
...
//!
//! The latter are all defined by the aingle conductor and implemented by HDK for you, but the former need to all be defined by your application.
...
//! ```
//!
//! And every host function defined by aingle has a convenience wrapper in HDK that does the type juggling for you.
//!
...
///
/// Annotate any compatible function with `#[hdk_extern]` to expose it to AIngle as a WASM extern.
