...
pub fn x_salsa20_poly1305_decrypt(
    ...
    host_call::<XSalsa20Poly1305Decrypt, Option<XSalsa20Poly1305Data>>(
        ...
        aingle_zome_types::x_salsa20_poly1305::XSalsa20Poly1305Decrypt::new(
            key_ref,
            encrypted_data,
        ),
    )
...
pub fn x_salsa20_poly1305_encrypt(
    ...
    host_call::<XSalsa20Poly1305Encrypt, XSalsa20Poly1305EncryptedData>(
        ...
        aingle_zome_types::x_salsa20_poly1305::XSalsa20Poly1305Encrypt::new(key_ref, data),
    )
}
...
pub fn x_25519_x_salsa20_poly1305_encrypt(
    ...
    host_call::<
        aingle_zome_types::x_salsa20_poly1305::X25519XSalsa20Poly1305Encrypt,
        XSalsa20Poly1305EncryptedData,
    >(
        __x_25519_x_salsa20_poly1305_encrypt,
        aingle_zome_types::x_salsa20_poly1305::X25519XSalsa20Poly1305Encrypt::new(
...
pub fn x_25519_x_salsa20_poly1305_decrypt(
    ...
    host_call::<X25519XSalsa20Poly1305Decrypt, Option<XSalsa20Poly1305Data>>(
        ...
        aingle_zome_types::x_salsa20_poly1305::X25519XSalsa20Poly1305Decrypt::new(
            recipient,
            sender,
            encrypted_data,
        ),
