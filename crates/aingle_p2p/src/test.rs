...
use aingle_hash::fixt::DnaHashFixturator;
...
mod tests {
    ...
    macro_rules! newhash {
        ($p:ident, $c:expr) => {
            aingle_hash::$p::from_raw_36([$c as u8; AINGLE_HASH_UNTYPED_LEN].to_vec())
        };
    }
    ...
    async fn test_get_links_workflow() {
        ...
        let hash = aingle_hash::EntryHash::from_raw_36_and_type(
            b"eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee".to_vec(),
            aingle_hash::hash_type::Entry,
        );
