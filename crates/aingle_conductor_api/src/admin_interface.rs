...
pub enum AdminRequest {
    ...
    /// Register a SAF for later use in InstallApp
    /// Stores the given SAF into the aingle safs database and returns the hash of the SAF
    /// Will be responded to with an [`AdminResponse::SafRegistered`]
    /// or an [`AdminResponse::Error`]
    ///
    /// [`RegisterSafPayload`]: ../../../aingle_types/app/struct.RegisterSafPayload.html
    /// [`AdminResponse::SafRegistered`]: enum.AdminResponse.html#variant.SafRegistered
    RegisterSaf(Box<RegisterSafPayload>),

    /// "Clone" a SAF (in the biological sense), thus creating a new Cell.
    ///
    /// Using the provided, already-registered SAF, create a new SAF with a unique
    /// UID and the specified properties, create a new Cell from this cloned SAF,
    /// and add the Cell to the specified App.
    ///
    /// Will be responded to with an [`AdminResponse::SafCloned`]
    /// or an [`AdminResponse::Error`]
    ///
    /// [`CreateCloneCellPayload`]: ../../../aingle_types/app/struct.CreateCloneCellPayload.html
    /// [`AdminResponse::SafCloned`]: enum.AdminResponse.html#variant.SafCloned
    CreateCloneCell(Box<CreateCloneCellPayload>),

    /// Install an app from a list of `Saf` paths.
    ...
    /// installs all the Safs with that `AgentPubKey` forming new `Cell`s.
    ...
    /// or an [`AdminResponse::Error`]
    ///
    /// [`InstallAppPayload`]: ../../../aingle_types/app/struct.InstallAppPayload.html
    ...
    /// or an [`AdminResponse::Error`]
    ///
    /// [`InstallAppBundlePayload`]: ../../../aingle_types/app/struct.InstallAppBundlePayload.html
    /// [`AdminRequest::ActivateApp`]: enum.AdminRequest.html#variant.ActivateApp
    /// [`AdminResponse::AppInstalled`]: enum.AdminResponse.html#variant.AppInstalled
    /// [`AdminResponse::Error`]: enum.AppResponse.html#variant.Error
    InstallAppBundle(Box<InstallAppBundlePayload>),

    /// List the hashes of all installed `Saf`s.
    /// Takes no arguments.
    ///
    /// Will be responded to with an [`AdminResponse::SafsListed`]
    /// or an [`AdminResponse::Error`]
    ///
    /// [`AdminResponse::SafsListed`]: enum.AdminResponse.html#variant.SafsListed
    /// [`AdminResponse::Error`]: enum.AppResponse.html#variant.Error
    ListSafs,
    ...
    /// This is another way of finding peers on a sgd.
    ///
...
pub enum AdminResponse {
    ...
    /// The successful response to an [`AdminRequest::RegisterSaf`]
    ///
    /// [`AdminRequest::RegisterSaf`]: enum.AdminRequest.html#variant.RegisterSaf
    SafRegistered(SafHash),
    ...
    /// of the newly installed `Saf`s. See the [`InstalledAppInfo`] docs for details.
    ///
    /// [`AdminRequest::InstallApp`]: enum.AdminRequest.html#variant.InstallApp
    /// [`InstalledAppInfo`]: ../../../aingle_types/app/struct.InstalledAppInfo.html
    /// [`CellNick`]: ../../../aingle_types/app/type.CellNick.html
    /// [`CellId`]: ../../../aingle_types/cell/struct.CellId.html
    ...
    /// The successful response to an [`AdminRequest::ListSafs`].
    ///
    /// Contains a list of the hashes of all installed `Saf`s
    ///
    /// [`AdminRequest::ListSafs`]: enum.AdminRequest.html#variant.ListSafs
    SafsListed(Vec<SafHash>),
    ...
    /// Contains the port number that was selected (if not specified) by AIngle
...
pub enum ExternalApiWireError {
    ...
    /// The saf path provided was invalid
    SafReadError(String),
