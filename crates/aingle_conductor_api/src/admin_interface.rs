...
pub enum AdminRequest {
    ...
    /// Stores the given DNA into the aingle dnas database and returns the hash of the DNA
    /// Will be responded to with an [`AdminResponse::DnaRegistered`]
    /// or an [`AdminResponse::Error`]
    ///
    /// [`InstallDnaPayload`]: ../../../aingle_types/app/struct.InstallDnaPayload.html
...
pub enum AdminResponse {
    ...
    ///
    /// [`AdminRequest::InstallApp`]: enum.AdminRequest.html#variant.InstallApp
    /// [`InstalledApp`]: ../../../aingle_types/app/struct.InstalledApp.html
