...
pub enum AppResponse {
    ...
    /// [`ExternIO`]: ../../../aingle_zome_types/zome_io/struct.ExternIO.html
    /// [`SerializedBytes`]: ../../../aingle_zome_types/query/struct.SerializedBytes.html
...
pub struct ZomeCall {
    ...
    ///
    /// NB: **This will go away** as soon as AIngle has a way of determining who
    /// is making this ZomeCall over this interface. Until we do, the caller simply
    /// provides this data and AIngle trusts them.
