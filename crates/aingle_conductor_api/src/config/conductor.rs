...
pub struct ConductorConfig {
    ...
    /// Bootstrapping step for AIngle closed-alpha.
    /// If set, all agents with aingle_remote_key = true will be emulated by asking for signatures
    /// over this websocket.
    ...
    pub network: Option<aingle_p2p::kitsune_p2p::KitsuneP2pConfig>,
    //
    //
...
pub mod tests {
    ...
    network:
      bootstrap_service: https://bootstrap.aingle.host
      transport_pool:
        - type: proxy
          sub_transport:
            type: quic
    ...
    "#;
        ...
        network_config.bootstrap_service = Some(url2::url2!("https://bootstrap.aingle.host"));
